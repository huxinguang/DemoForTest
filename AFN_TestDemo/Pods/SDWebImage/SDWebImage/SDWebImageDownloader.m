...
#warning ******理解这里cachePolicy的取值很关键******
        /*
         当我们对UIImageView实例用 sd_setImageWithURL: placeholderImage: options: 方法设置图片时，传的options参数值
         
         若为 SDWebImageRefreshCached ，由本方法的options来源可知道, 本方法的options值为SDWebImageDownloaderUseNSURLCache
         此时 cachePolicy 的取值为 NSURLRequestUseProtocolCachePolicy，
